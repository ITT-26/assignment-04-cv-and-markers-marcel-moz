...
- Run [`image_extractor.py`](./perspective_transformation/image_extractor.py) located in [`perspective_transformation`](./perspective_transformation/) via command line (from this directory)
